...
object TypesProviderActor:
    ...
    final case class Get(name: String, replyTo: ActorRef[Option[AbstractEntityType[_, _, _, _]]]) extends Command
    final case class GetAll(replyTo: ActorRef[Seq[AbstractEntityType[_, _, _, _]]]) extends Command
