...
import my.valerii_timakov.sgql.entity.domain.type_values.{ArrayValue, CustomPrimitiveValue, Entity, EntityId, EntityValue, FilledEntityId, ValueTypes, ItemValue, ObjectValue, RootPrimitiveValue}
